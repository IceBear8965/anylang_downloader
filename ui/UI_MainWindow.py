...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.urlField = QLineEdit(self.centralwidget)
        ...
        self.logsField = QPlainTextEdit(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.runBtn.setText(QCoreApplication.translate("MainWindow", u"Fetch Book", None))
    # retranslateUi
